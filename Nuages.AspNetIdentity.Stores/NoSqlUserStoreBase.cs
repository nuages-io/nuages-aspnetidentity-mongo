    ...
    where TUserRole : IdentityUserRole<TKey>, new()
{
    ...
    public Task<TUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken)
    {
        ...
        return login == null
            ...
            : Task.FromResult(Users.SingleOrDefault(u => u.Id.Equals(login.UserId)))!;
    }
    ...
    public Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken)
    {
        ...
        var query = from p in UsersRoles.Where(u => u.UserId.Equals(user.Id))
    ...
    public Task<string?> GetAuthenticatorKeyAsync(TUser user, CancellationToken cancellationToken)
    {
        ...
        return GetTokenAsync(user, AuthenticatorInfo.AuthenticatorStoreLoginProvider,
            AuthenticatorInfo.AuthenticatorKeyTokenName, cancellationToken);
    }
    ...
    public async Task<int> CountCodesAsync(TUser user, CancellationToken cancellationToken)
    {
        ...
        var mergedCodes = await GetTokenAsync(user, AuthenticatorInfo.AuthenticatorStoreLoginProvider,
            AuthenticatorInfo.RecoveryCodeTokenName, cancellationToken) ?? "";
    ...
    public Task SetAuthenticatorKeyAsync(TUser user, string key, CancellationToken cancellationToken)
    {
        ...
        return SetTokenAsync(user, AuthenticatorInfo.AuthenticatorStoreLoginProvider,
            AuthenticatorInfo.AuthenticatorKeyTokenName, key, cancellationToken);
    }
    ...
    public Task ReplaceCodesAsync(TUser user, IEnumerable<string> recoveryCodes, CancellationToken cancellationToken)
    {
        ...
        return SetTokenAsync(user, AuthenticatorInfo.AuthenticatorStoreLoginProvider,
            AuthenticatorInfo.RecoveryCodeTokenName, mergedCodes, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (tokenEntity != null) await RemoveTokenAsync(tokenEntity);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (loginEntity != null) await RemoveUserLoginAsync(loginEntity);
    }
